      ...
      <div className="glass-card p-6 sm:p-8 rounded-3xl space-y-4 bg-gradient-to-r from-slate-950 via-slate-900 to-emerald-950 text-white border-2 border-emerald-500/30">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            ...
            <p className="text-xs text-slate-300">Enjoy up to 8 hours of play for just <strong>₱70 / person</strong>. Limited to 16 players. Onsite payment only after your game via cash or GCash.</p>
          </div>
